...
class AnInfoNCELoss(CLLoss):
    def __init__(self, batch_size, lambda_train, lambda_activation):
        self.lambda_train = lambda_train
        self.lambda_activation = lambda_activation
        self.mask = self.mask_correlated_samples(batch_size).to('cuda')
        self.normalize = True
    ...
    def loss(self, z1, z2_con_z1, z3, z1_rec, z2_con_z1_rec, z3_rec):
        ...
        def get_neg_term(z_a: torch.Tensor, z_b: torch.Tensor
                              ) -> torch.Tensor:
